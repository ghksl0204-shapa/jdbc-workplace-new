...
public class SpeciesService {
	...
	private SpeciesDao sdao = new SpeciesDao(); 
	
	public int save(SpeciesDto sd) {
		// speciesName 의 길이, 중복검사, 유효성검사 -> 나중에 천천히
		return sdao.save(sd);
	}
